...
<!-- CREAMOS UN FORMULARIO PARA LA INFORMACIÓN PERSONAL Y DE PAGO -->
    <form @submit.prevent="submitForm">
        ...
        <!-- COMENTARIOS -->
        <div class="mb-4">
            <label class="block text-gray-700">Deja tu comentario</label>
        ...
        <!-- BOTÓN PARA ENVIAR FORMULARIO -->
            <button type="submit" class="w-full bg-[#47462d]/50 text-white p-2 rounded-md hover:bg-[#47462d] transition duration-300">HAZTE SOCIA/O</button>
    </form>
</div>
</template>
