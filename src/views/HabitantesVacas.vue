<template>
    <div>
        ...
        <div class="texto">
            <h1 class="text-[#47462d] text-9xl text-center mt-20 mx-20">
                Conoce a nuestras vacas
            </h1>
            <p class=" text-[#47462d] text-2xl text-center mx-36 my-16">
                ¡Aquí te explicamos una curiosidad sobre estos animales tan espectaculares!
            </p>
            <p class=" text-[#47462d] text-2xl text-center mx-36 my-16">
                Las vacas tienen un sentido del olfato excepcional; pueden detectar olores a una distancia de hasta 10
                kilómetros. Esto les ayuda no solo a encontrar alimento, sino también a comunicarse entre ellas a través
                de feromonas.
            </p>
            <p class=" text-[#47462d] text-2xl text-center mx-36 my-16 ">
                Además, las vacas tienen una excelente memoria y pueden recordar rostros y lugares durante mucho tiempo.
                Esto les permite reconocer a sus cuidadores y compañeros, lo que refuerza sus lazos sociales.
            </p>
            <p class=" text-[#47462d] text-2xl text-center mx-36 my-16">
                Estas curiosidades muestran que las vacas son animales fascinantes con comportamientos únicos y
                características sorprendentes que merecen ser apreciadas y respetadas.
            </p>
        </div>
    ...
    <div class="texto grid_habitantes grid grid-cols-2 gap-12">
        ...
        <div
            ...
            <h4 class="text-justify text-[#47462d] mx-12 my-6 text-2xl">Margot fue rescatada de un matadero clandestino
                ...
                el cuerpo. Los veterinarios descubrieron que tenía una infección pulmonar grave debido a las pésimas
                condiciones en las que vivía. Gracias a los cuidados intensivos y al amor recibido en el Santuario
                PATOdalavida, Margot se recuperó completamente. Ahora disfruta pastando en los verdes prados y tomando
        ...
        <div
            ...
            <h4 class="text-justify text-[#47462d] mx-12 my-6 text-2xl">Gaia llegó al santuario tras ser abandonada en
                ...
                una severa anemia y desnutrición. Con paciencia y una dieta especial, Gaia fue ganando peso y fuerza.
                Hoy en día, es conocida por su curiosidad y le encanta explorar cada rincón del santuario, siempre
        ...
        <div
            ...
            <h4 class="text-justify text-[#47462d] mx-12 my-6 text-2xl">Olivia fue rescatada de una granja industrial
                ...
                y con una mastitis crónica. Tras meses de tratamiento y cuidados, Olivia se recuperó por completo. Ahora
        ...
        <div
            ...
            <h4 class="text-justify text-[#47462d] mx-12 my-6 text-2xl">Valeria fue encontrada atada a un árbol en un
                ...
                desnutrición severa. En el Santuario PATOdalavida, recibió tratamiento podológico y una alimentación
        ...
        <div
            ...
            <h4 class="text-justify text-[#47462d] mx-12 my-6 text-2xl">Manuela llegó al santuario tras ser rescatada de
                una granja donde la utilizaban para espectáculos taurinos. Estaba aterrorizada y mostraba signos de
        ...
        <div
            ...
            <h4 class="text-justify text-[#47462d] mx-12 my-6 text-2xl">Clara fue rescatada de un matadero en la
                provincia de Almería, donde estaba destinada a ser sacrificada. Cuando los rescatistas llegaron, Clara
                estaba aterrorizada y herida. Después de recibir atención veterinaria en el Santuario PATOdalavida,
        ...
        <div
            ...
            <h4 class="text-justify text-[#47462d] mx-12 my-6 text-2xl">Vicente llegó al santuario tras ser decomisado
                ...
                mucho amor y paciencia, Vicente fue sanando no solo físicamente sino también emocionalmente. Ahora es
        ...
        <div
            ...
            <h4 class="text-justify text-[#47462d] mx-12 my-6 text-2xl">Freser y Catalina fueron rescatados de una
                ...
                cuando el Santuario PATOdalavida intervino. Al llegar, estaban asustados y en mal estado de salud. Tras
    ...
    <div>
        <p class="socio text-[#47462d] text-2xl text-center mx-36 my-16">
            Estas historias destacan no solo las dificultades que enfrentan muchos animales antes de ser rescatados,
            sino también la esperanza y la felicidad que pueden encontrar en santuarios como PATOdalavida tras haber
            superado sus traumas pasados.
        </p>
        <p class="socio text-[#47462d] text-2xl text-center mx-36 my-16">
            En PATOdalavida hay muchas historias como las de Margot, Catalina, Olivia, Valeria, Manuela, Emilio y
            Vicente. Cada vaca tiene su propio viaje hacia la libertad y la felicidad después del sufrimiento. El
            santuario no solo les ofrece un hogar seguro; también les brinda amor incondicional y respeto por sus vidas.
            Cada visita al santuario es una oportunidad para aprender sobre estos maravillosos animales y contribuir a
            su bienestar. Juntos podemos hacer una diferencia significativa en sus vidas. Estas historias conmovedoras
            pueden ayudar a sensibilizar sobre la importancia del rescate animal y el trabajo realizado por santuarios
            como PATOdalavida.
        </p>
    </div>

    <div class="text-center mt-10"> 
        <button @click="navigateTo('/HabitantesGeneral/Habitantes')"
            class="bg-[#47462d] text-white px-4 py-2 rounded-md hover:bg-[#333] transition duration-300 mb-20"> Volver a
            Habitantes 
        </button> 
    </div>
